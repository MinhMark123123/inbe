...
class DevEnvConfigs implements BaseEnvConfigs {
  @override
  ...
  String get ASC_COMMUNITY_API_BASE_URL => 'https://aquacity.novaid.vn/app/api';

  @override
  // TODO: implement ASC_OPERATION_API_BASE_URL
  String get ASC_OPERATION_API_BASE_URL => 'https://aquacity.novaid.vn/web/api';
}
