...
class InabeEmailInputWidget extends StatelessWidget {
  bool enable;
  bool readOnly;
  bool showPrefix;
  String? hintText;
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      ...
      builder: (context, value, __) {
        print("ttt --> Inabe email input value listener");
        return Column(
          children: [
            InabeTextInput(
              enable: enable,
  ...
  Widget get _buildValidation => Visibility(
        ...
        visible: !isFirst && TextUtils.isNotEmpty(controller.validateEmail()),
        child: Container(
